...
# - src-tauri/Cargo.toml: version = "0.2.2"
...
./scripts/sign-release.sh "src-tauri/target/release/bundle/nsis/Loci.Notepad_0.2.2_x64-setup.exe" private.key
...
| `src-tauri/tauri.conf.json` | `"version"` | `"0.2.2"` |
| `src-tauri/Cargo.toml` | `version` | `0.2.2` |
| Git tag | Tag name | `app-v0.2.2` |
| `updates/latest.json` | `"version"` | `"0.2.2"` |
